...
import com.sparta.sportify.config.RestTemplateConfig;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtUtil jwtUtil, UserDetailsService userDetailsService, RestTemplate restTemplate) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (token != null && isKakaoToken(token)) {
            // 카카오 API 응답에서 사용자 정보 추출
            OAuthUserInfo userInfo = getUserInfoFromKakao(token);
