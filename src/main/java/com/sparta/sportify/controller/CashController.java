...
public class CashController {
	...
	public ResponseEntity<ApiResult<CashResponseDto>> approveCash(
		...
		// 결제 승인 요청 DTO 생성
		KakaoPayApproveRequestDto approveRequestDto = new KakaoPayApproveRequestDto();
		approveRequestDto.setTid(tid);
		approveRequestDto.setPgToken(pgToken);
		approveRequestDto.setUserId(userDetails.getUser().getId().toString());
		approveRequestDto.setAmount(amount);
