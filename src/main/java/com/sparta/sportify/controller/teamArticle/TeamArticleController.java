...
public class TeamArticleController {
	...
	public ResponseEntity<ApiResult<TeamArticleResponseDto>> createPost(
		...
		return ResponseEntity.ok(
			ApiResult.success("게시글 등록 성공", teamArticleService.createPost(teamId, userDetails, teamArticleRequestDto)));
	}
	...
	public ResponseEntity<ApiResult<TeamArticleResponseDto>> updatePost(
		...
		return ResponseEntity.ok(ApiResult.success("게시글 수정 성공",teamArticleService.updatePost(articleId, teamArticleRequestDto, userDetails)));
	}
	...
	public ResponseEntity<ApiResult<TeamArticleResponseDto>> deletePost(
		...
		return ResponseEntity.ok(ApiResult.success("게시글 삭제 성공", teamArticleService.deletePost(articleId, userDetails)));
	}
}
